 ...
 *
 * By default, [[\Tui::$container]] refers to a Container instance which is used by [[\Tui::createObject()]]
 ...
 *
 * use tui\base\BaseObject;
 * use tui\db\Connection;
 ...
 * $container->set('tui\db\Connection', [
 *     'dsn' => '...',
 * ]);
...
class Container extends Component
{
     ...
     *
     * If the class implements [[\tui\base\Configurable]], the `$config` parameter will be passed as the last
     ...
     * $container->set('tui\mail\MailInterface', 'tui\swiftmailer\Mailer');
     *
     * // register an alias name. You can use $container->get('foo')
     * // to create an instance of Connection
     * $container->set('foo', 'tui\db\Connection');
     *
     ...
     *     return new \tui\db\Connection($config);
     * });
     * ```
     *
    ...
    protected function build($class, $params, $config)
    {
        ...
        if (!empty($dependencies) && $reflection->implementsInterface('tui\base\Configurable')) {
     ...
     *
     * ```php
     * $formatString = function($string, \tui\i18n\Formatter $formatter) {
     *    // ...
     * }
     * Tui::$container->invoke($formatString, ['string' => 'Hello World!']);
     * ```
     *
    ...
    public function resolveCallableDependencies(callable $callback, $params = [])
    {
        ...
        foreach ($reflection->getParameters() as $param) {
            ...
            if (($class = $param->getClass()) !== null) {
                ...
                } elseif (isset(Tui::$app) && Tui::$app->has($name) && ($obj = Tui::$app->get($name)) instanceof $className) {
                    $args[] = $obj;
                } else {
     ...
     *     'tui\web\Request' => 'app\components\Request',
     *     'tui\web\Response' => [
