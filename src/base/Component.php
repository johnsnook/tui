...
use Tui;
use tui\helpers\StringHelper;

/**
 * Component is the base class that implements the *property*, *event* and *behavior* features.
 *
 * Component provides the *event* and *behavior* features, in addition to the *property* feature which is implemented in
 * its parent class [[\tui\base\BaseObject|BaseObject]].
 *
 ...
 * ```
 *
 * where `as tree` stands for attaching a behavior named `tree`, and the array will be passed to [[\Tui::createObject()]]
...
class Component extends BaseObject
{
    ...
    public function __set($name, $value)
    {
        ...
        if (method_exists($this, $setter)) {
            ...
            $this->attachBehavior($name, $value instanceof Behavior ? $value : Tui::createObject($value));
     ...
     *     Tui::trace($event->name . ' is triggered.');
     * });
     * ```
     *
     * @param string $name the event name
     ...
     *  - an object configuration array that will be passed to [[Tui::createObject()]] to create the behavior object.
     *
    ...
    private function attachBehaviorInternal($name, $behavior)
    {
        if (!($behavior instanceof Behavior)) {
            $behavior = Tui::createObject($behavior);
        }
        if (is_int($name)) {
