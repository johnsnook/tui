 ...
 *
 * ```php
 * $locator = new \tui\di\ServiceLocator;
 ...
 * ```
 *
 * Because [[\tui\base\Module]] extends from ServiceLocator, modules and the application are all service locators.
...
class ServiceLocator extends Component
{
    ...
    public function get($id, $throwException = true)
    {
        ...
        if (isset($this->_definitions[$id])) {
            ...
            return $this->_components[$id] = Tui::createObject($definition);
     ...
     * ```php
     * // a class name
     * $locator->set('cache', 'tui\caching\FileCache');
     *
     ...
     *     return new \tui\caching\FileCache;
     * });
     *
     * // an instance
     * $locator->set('cache', new \tui\caching\FileCache);
     * ```
     *
